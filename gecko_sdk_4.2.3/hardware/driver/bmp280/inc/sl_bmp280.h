...
/***************************************************************************//**
 * @brief
 *    Initiate humidity measurement on the barometric pressure sensor and
 *    read humidity from it.
 *
 * @param[in] i2cspm
 *   The I2CSPM instance to use.
 *
 ...
 *
 * @retval SL_STATUS_OK Success
 * @retval SL_STATUS_FAIL Failure during humidity measurement/read
 ******************************************************************************/
